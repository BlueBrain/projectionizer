...
def test__full_sample_worker():
    ...
    with patch('projectionizer.synapses._sample_with_flat_index') as mock_sample:
        ...
        segs_df = test_module._full_sample_worker([min_xyz],
                                                  circuit_path,
                                                  voxel_dimensions,
                                                  )
        ...
        segs_df = test_module._full_sample_worker([new_min_xyz],
                                                  circuit_path,
                                                  voxel_dimensions,
                                                  )
...
def test_full_sample_parallel():
    ...
    with patch('projectionizer.synapses._sample_with_flat_index') as mock_sample, \
            patch('projectionizer.utils.map_parallelize', kwarg_map):
        ...
        with setup_tempdir('test_hippocampus') as outdir:
            ...
            test_module.full_sample_parallel(brain_regions,
                                             REGION,
                                             REGION_ID,
                                             circuit_path,
                                             outdir)
