...
circuit_path = "/gpfs/bbp.cscs.ch/project/proj45/circuits/SomatosensoryCxS1-v5.r0/O1_SynthProj/merged_circuit/CircuitConfig"
...
#c =  bluepy.Circuit("/gpfs/bbp.cscs.ch/project/proj45/circuits/SomatosensoryCxS1-v5.r0/O0_SynthProj/merged_circuit/CircuitConfig")
...
model = c
mesoCenter = model.RUN.CentralHyperColumn
...
# gid to mtype
gid_mtypes = numpy.array([x.morphology for x in c.mvd_neurons])
...
for bin in range(num_bins):
    ...
    pre_gids = results[:,9].astype(int)
    mtype_ids = gid_mtypes[pre_gids-1]

    projSynapses[bin] = numpy.sum(mtype_ids==c.mtype_ids['PROJ_VPM'])
